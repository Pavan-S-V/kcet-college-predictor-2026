...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Get Your Dream College and Course — KCET Counseling" },
      { name: "description", content: "AI-powered KCET counseling, college predictor, branch advisor and seat-matrix insights for Karnataka engineering aspirants." },
